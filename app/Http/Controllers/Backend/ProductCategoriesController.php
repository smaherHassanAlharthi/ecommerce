...
class ProductCategoriesController extends Controller
{
    ...
    public function store(ProductCategoryRequest $request)
    {
        ...
        if ($image = $request->file('cover')) {
            ...
            $path = public_path('public/assets/product_categories/' . $file_name);
    ...
    public function update(ProductCategoryRequest $request, ProductCategory $productCategory)
    {
        ...
        if ($image = $request->file('cover')) {
            if ($productCategory->cover != null && File::exists('public/assets/product_categories/'. $productCategory->cover)){
    ...
    public function remove_image(Request $request)
    {
        ...
        if (File::exists('public/assets/product_categories/'. $category->cover)){
            unlink('public/assets/product_categories/'. $category->cover);
            $category->cover = null;
            $category->save();
        }
        return true;
